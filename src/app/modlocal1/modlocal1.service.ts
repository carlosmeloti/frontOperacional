...
export class Modlocal1Service {
  ...
  modlocal1URL = 'http://10.132.90.58:8080/unidadedeavaliacao';
  ...
  pesquisar(filtro: Modlocal1Filtro): Promise<any> {
    ...
    return this.http.get(`${this.modlocal1URL}?resumo`, {  headers, search: filtro })
    .toPromise()
      .then(response => {
    ...
    excluir(codigo: number): Promise<void> {
      ...
      return this.http.delete(`${this.modlocal1URL}/${codigo}`, { headers })
        .toPromise()
        .then(() => null);
    }
   ...
   atualizar(modlocal1: Modlocal1): Promise<Modlocal1>{
     ...
     return this.http.put(`${this.modlocal1URL}/${modlocal1.codigo}`,
